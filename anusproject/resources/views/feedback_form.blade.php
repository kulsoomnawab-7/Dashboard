			...
			<div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                       ...
                       <input type="text" class="pl-5"name="faculty_batch" style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:16rem;" required>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 offset-md-1">
                       ...
                       <input type="text" class="pl-5" name="subject" style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none;" required>
                       
                    </div>

                    <div class="col-md-6">
                        <label for="" style="font-weight: bold; font-size: 1rem;"> Std .Name & ID</label>    
                       <input type="text" class="pl-5" value="{{$studcheck->Std_Name}} / {{$studcheck->Std_id}}" name="std_name_id" style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:16rem;">
						  ...
						  <tbody>
							<tr class="highlight" >
                                            ...
                                            <div class="field">
                                                <p class="control">
                                                  <label class="checkbox">
                                                    <input type="radio" id="Check1" value="Every Class" name="punctuality" onclick="selectOnlyThis(this.id)" required/> Every Class
                                                  </label>
                                                </p>
                                                    <p class="control">
                                                  <label class="checkbox">
                                                    <input type="radio" id="Check2" value="Most of the Classes" name="punctuality" onclick="selectOnlyThis(this.id)" required/> Most of the Classes
                                                  </label>
                                                </p>
                                                <p class="control">
                                                  <label class="checkbox">
                                              <input type="radio" id="Check3" value="Rarely" name="punctuality" onclick="selectOnlyThis(this.id)" required/> Rarely
                                                  </label>
                                                </p>
                                                <p class="control">
                                                  <label class="checkbox">
                                                  <input type="radio" id="Check4" value="Never" name="punctuality" onclick="selectOnlyThis(this.id)" required/> Never
                                                  </label>
                                                </p>
                                              </div>
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <div class="field">
                                                <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Yes" name="course_insert[]" required> Yes
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="course_insert[]" value="No, specify the topics missed" required> No, specify the topics missed:
                                                    <input type="text" name="course_insert[]" id="custom" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;" required>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            <h3 style="height: 2.3rem;">3. (Technical Supports) Does faculty guide you during your lab exercide?</h3>
                                            <hr style="border:1px solid black;">
                                            <div class="field">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('customs').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Excellent" name="technical[]" required> Excellent
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                  <input onclick="document.getElementById('customs').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Good" name="technical[]" required> Good
                                                  </label>
                                                </p>
                                                ...
                                                <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('customs').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Average" name="technical[]" required> Average                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('customs').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="technical[]" value="Fair" required> Fair
                                                    <input type="text" name="technical[]" id="customs" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom1').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Excellent" name="clearing[]" required> Excellent
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom1').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Good" name="clearing[]" required> Good                                                  
                                                  </label>
                                                </p>

                                                <p class="control">
                                                  <label class="checkbox">
                                                  <input onclick="document.getElementById('custom1').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Average" name="clearing[]" required> Average                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom1').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="clearing[]" value="Fair" required> Fair
                                                    <input type="text" name="clearing[]" id="custom1" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            <h3 style="height: 2.3rem;">5. (Exam & Assignment) Are exams & assignment taken on a montly basis and timely feedback & result provided?</h3>
                                            <hr style="border:1px solid black;">
                                            <div class="field">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom2').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Yes" name="exam[]" required> Yes                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom2').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="exam[]" value="No, specify the topics missed" required> No, specify the topics missed:
                                                    <input type="text" name="exam[]" id="custom2" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;" required>
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Excellent" name="book[]" required> Excellent
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Good" name="book[]" required> Good                                                  
                                                  </label>
                                                </p>
                                                ...
                                                <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Average" name="book[]" required> Average                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom3').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="book[]" value="Fair" required> Fair
                                                    <input type="text" name="book[]" id="custom3" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom4').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Yes" name="student[]" required> Yes                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom4').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="student[]" value="No, specify the topics missed" required> No, specify the topics missed:
                                                    <input type="text" name="student[]" id="custom4" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;" required>                                                  
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            <h3 style="height: 2.3rem;">8. (Computer Uptime) Your complaints regarding computer System/Software are handled withina a reasonable timeframe?</h3>
                                            <hr style="border:1px solid black;">
                                            <div class="field">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom5').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="No Issues in Computer System/Software" name="computer[]" required> No Issues in Computer System/Software
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                  <input onclick="document.getElementById('custom5').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Issues reported & resloved in reasonable time" name="computer[]" required> Issues reported & resloved in reasonable time                                           
                                                  </label>
                                                </p>

                                                <p class="control">
                                                  <label class="checkbox">
                                                  <input onclick="document.getElementById('custom5').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="Issue resolution is delayed" name="computer[]" required> Issue resolution is delayed                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom5').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="computer[]" value="Not resloved, specify the Issue" required> Not resloved, specify the Issue
                                                    <input type="text" name="computer[]" id="custom5" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                  <!-- <p class="control">
                                                    <label class="checkbox">
