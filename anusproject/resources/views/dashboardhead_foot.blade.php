        ...
        <div class="container-fluid p-0">
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between p-0">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img src="dashboard/images/LOGO 2.png"style="width:400px; height:150px;" alt="logo"/></a>
            ...
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  <a href="/student_profile" class="nav-link">
                    ...
                    <span class="menu-title">Profile</span></a>
              </li>
