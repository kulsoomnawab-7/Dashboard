...
class studentcontroller extends Controller
{
    ...
    { 
        ...
        if(isset($studcheck))
        {
            ...
            $feedback_insert->faculty_batch = $req->faculty_batch;
...

    {
        ...
        {
           $attendances = DB::table('attendances')->where('Std_ID' ,session("std_id"))->orderBy('id','desc')->get();
           return view('attendances',compact('attendances'));
        }

        public function student_profile()
        {
           $std_profile = DB::table('students')->where('Std_ID' ,session("std_id"))->get();
